...
class Court(models.Model):
	...
	FUTBOL7 = 'F7'
	FUTBOL11 = 'F11'
	artificial_light = models.BooleanField(verbose_name='Luz Artificial')
	lawnType_choices = (
	...
	name = models.CharField(max_length=50, verbose_name='Id o nombre de cancha')
	def __str__(self):
		return '%s %s %s %s' %(self.name,self.get_lawnType_display(), self.get_soccerType_display(), self.complex.name)